        ...
        {showLimitSelector && onLimitChange && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="min-h-[44px] sm:min-h-0 rounded-lg border border-gray-300 px-3 py-2 text-base sm:text-sm focus:border-black focus:outline-none shrink-0 touch-manipulation"
            >
